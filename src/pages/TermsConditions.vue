<template>
  ...
  >
    <p>
      Welcome to Visionlink Holding Limited! These terms and conditions outline
      the rules and regulations for the use of Visionlink Holding Limited's
      Website, located at Visionlink Holding Limited App. By accessing this
      website we assume you accept these terms and conditions. Do not continue
      to use Visionlink Holding Limited if you do not agree to take all of the
      ...
      in accordance with and subject to, prevailing law of hk. Any use of the
      ...
      Visionlink Holding Limited, you agreed to use cookies in agreement with
      the Visionlink Holding Limited's Privacy Policy. Most interactive websites
      use cookies to let us retrieve the user's details for each visit. Cookies
      ...
      otherwise stated, Visionlink Holding Limited and/or its licensors own the
      intellectual property rights for all material on Visionlink Holding
      Limited. All intellectual property rights are reserved. You may access
      this from Visionlink Holding Limited for your own personal use subjected
      to restrictions set in these terms and conditions. You must not: Republish
      material from Visionlink Holding Limited Sell, rent or sub-license
      material from Visionlink Holding Limited Reproduce, duplicate or copy
      material from Visionlink Holding Limited Redistribute content from
      Visionlink Holding Limited This Agreement shall begin on the date hereof.
      Our Terms and Conditions were created with the help of the Free Terms and
      Conditions Generator. Parts of this website offer an opportunity for users
      to post and exchange opinions and information in certain areas of the
      website. Visionlink Holding Limited does not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not
      reflect the views and opinions of Visionlink Holding Limited,its agents
      ...
      laws, Visionlink Holding Limited shall not be liable for the Comments or
      ...
      website. Visionlink Holding Limited reserves the right to monitor all
      Comments and to remove any Comments which can be considered inappropriate,
      offensive or causes breach of these Terms and Conditions. You warrant and
      ...
      activities or unlawful activity. You hereby grant Visionlink Holding
      Limited a non-exclusive license to use, reproduce, edit and authorize
      ...
      distributors may link to our Website in the same manner as they hyperlink
      to the Websites of other listed businesses; and System wide Accredited
      ...
      of Visionlink Holding Limited; and (d) the link is in the context of
      general resource information. These organizations may link to our home
      page so long as the link: (a) is not in any way deceptive; (b) does not
      falsely imply sponsorship, endorsement or approval of the linking party
      and its products or services; and (c) fits within the context of the
      ...
      inform us by sending an e-mail to Visionlink Holding Limited. Please
      ...
      Visionlink Holding Limited's logo or other artwork will be allowed for
      ...
      our Website. Content Liability We shall not be hold responsible for any
      content that appears on your Website. You agree to protect and defend us
      against all claims that is rising on your Website. No link(s) should
      appear on any Website that may be interpreted as libelous, obscene or
      criminal, or which infringes, otherwise violates, or advocates the
      infringement or other violation of, any third party rights. Reservation of
      Rights We reserve the right to request that you remove all links or any
      ...
      terms and conditions. Removal of links from our website If you find any
      link on our Website that is offensive for any reason, you are free to
      contact and inform us any moment. We will consider requests to remove
      links but we are not obligated to or so or to respond to you directly. We
      do not ensure that the information on this website is correct, we do not
      ...
      to date. Disclaimer To the maximum extent permitted by applicable law, we
      ...
      liabilities that may not be excluded under applicable law. The limitations
      and prohibitions of liability set in this Section and elsewhere in this
      ...
      contract, in tort and for breach of statutory duty. As long as the website
